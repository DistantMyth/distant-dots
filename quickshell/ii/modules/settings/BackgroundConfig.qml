    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                onCheckedChanged: {
                    Config.options.background.widgets.visualizer.vertical = checked;
                }
            }
        }
        ...
        ConfigSpinBox {
            ...
            stepSize: 1
            onValueChanged: {
                Config.options.background.widgets.visualizer.bars = value;
            }
        }
    }
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                onCheckedChanged: {
                    Config.options.background.widgets.stats.enable = checked;
                }
            }
            Item {
                Layout.fillWidth: true
            ...
            ConfigSelectionArray {
                ...
                onSelected: newValue => {
                    Config.options.background.widgets.stats.placementStrategy = newValue;
                }
                options: [
                    {
                        displayName: Translation.tr("Draggable"),
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                onCheckedChanged: {
                    Config.options.background.widgets.stats.showGraphs = checked;
                }
            }
        }
        ...
        ContentSubsection {
            ...
            MaterialTextArea {
                ...
                wrapMode: TextEdit.Wrap
                onTextChanged: {
                    Config.options.background.widgets.stats.githubUsername = text;
                }
            }
            MaterialTextArea {
                Layout.fillWidth: true
                ...
                wrapMode: TextEdit.Wrap
                onTextChanged: {
                    Config.options.background.widgets.stats.codeforcesUsername = text;
                }
            }
        }
    }
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                onCheckedChanged: {
                    Config.options.background.widgets.systemResources.enable = checked;
                }
            }
            Item {
                Layout.fillWidth: true
            ...
            ConfigSelectionArray {
                ...
                onSelected: newValue => {
                    Config.options.background.widgets.systemResources.placementStrategy = newValue;
                }
                options: [
                    {
                        displayName: Translation.tr("Draggable"),
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                onCheckedChanged: {
                    Config.options.background.widgets.systemResources.showGraphs = checked;
                }
            }
        }
    }
